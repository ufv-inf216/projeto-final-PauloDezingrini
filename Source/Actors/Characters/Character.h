...
public:
    explicit Character(Game* game, const std::string &name, const std::string &texturePath, bool isPlayer, float size = 64.0f, float forwardSpeed = 1500.0f, float mass = 1.0f);
